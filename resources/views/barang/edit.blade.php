        ...
        <form action="{{ route('barangs.update', $barang->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-1 gap-4">
                <div>
                    ...
                    <input type="number" name="harga_beli" value="{{ old('harga_beli', $barang->harga_beli) }}" class="w-full border-gray-300 rounded mt-1" required>
                </div>

                <div>
                    <label class="block font-medium">Harga Grosir 1</label>
                    <input type="number" name="harga_grosir_1" value="{{ old('harga_grosir_1', $barang->harga_grosir_1) }}" class="w-full border-gray-300 rounded mt-1" required>
                </div>
                <div>
                    <label class="block font-medium">Harga Grosir 2</label>
                    <input type="number" name="harga_grosir_2" value="{{ old('harga_grosir_2', $barang->harga_grosir_2) }}" class="w-full border-gray-300 rounded mt-1" required>
                </div>
                <div>
                    <label class="block font-medium">Harga Grosir 3</label>
                    <input type="number" name="harga_grosir_3" value="{{ old('harga_grosir_3', $barang->harga_grosir_3) }}" class="w-full border-gray-300 rounded mt-1" required>
                </div>
                <div>
                    <label class="block font-medium">Harga Grosir 4</label>
                    <input type="number" name="harga_grosir_4" value="{{ old('harga_grosir_4', $barang->harga_grosir_4) }}" class="w-full border-gray-300 rounded mt-1" required>
                </div>
            </div>
